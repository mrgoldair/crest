...
For more info, visit https://reactjs.org/link/mock-scheduler`);
  ...
  // ../compiler/out/TokenType.js
  var TokenType;
  (function(TokenType2) {
    TokenType2[TokenType2["NUMBER"] = 0] = "NUMBER";
    TokenType2[TokenType2["PLUS"] = 1] = "PLUS";
    TokenType2[TokenType2["MINUS"] = 2] = "MINUS";
    TokenType2[TokenType2["SLASH"] = 3] = "SLASH";
    TokenType2[TokenType2["STAR"] = 4] = "STAR";
    TokenType2[TokenType2["LEFT_PAREN"] = 5] = "LEFT_PAREN";
    TokenType2[TokenType2["RIGHT_PAREN"] = 6] = "RIGHT_PAREN";
    TokenType2[TokenType2["COS"] = 7] = "COS";
    TokenType2[TokenType2["SIN"] = 8] = "SIN";
    TokenType2[TokenType2["X"] = 9] = "X";
    TokenType2[TokenType2["EOF"] = 10] = "EOF";
    TokenType2[TokenType2["SEMICOLON"] = 11] = "SEMICOLON";
    TokenType2[TokenType2["COMMA"] = 12] = "COMMA";
  })(TokenType || (TokenType = {}));

  // ../compiler/out/Scanner.js
  var Scanner = class {
    constructor(source) {
      this.tokens = [];
      this.start = 0;
  ...
  // ../compiler/out/Expression.js
  var Expr = class {
  };
  var BinaryExpr = class extends Expr {
  ...
  var UnaryExpr = class extends Expr {
  ...
  var GroupExpr = class extends Expr {
    constructor(expr) {
      super();
      this.expr = expr;
    }
  ...
  var CallExpr = class extends Expr {
  ...
  var VariableExpr = class extends Expr {
    constructor(name) {
      super();
      this.name = name;
    }
  ...
  var Parser = class {
    ...
    arguments(callee) {
      ...
      let paren = this.consume(TokenType.RIGHT_PAREN, "Expecting ')' after arguments.");
  ...
  // ../compiler/out/Compiler.js
  var Compiler = class {
    constructor() {
      this.globals = new Environment();
      this.globals.define("cos", new class {
        arity() {
          return 1;
        }
        call(interpreter, [x]) {
    ...
    visitCallExpr({callee, args}) {
      let callable = this.compile(callee);
      if (args.length != callable.arity()) {
        throw new Error(`Expected ${callable.arity()} arguments but got ${args.length}.`);
      }
      return `Math.${callee.name.lexeme}(${args.map((arg) => this.compile(arg)).join(", ")})`;
    }
    visitBinaryExpr(expr) {
      return `${this.compile(expr.left)} ${expr.operator.lexeme} ${this.compile(expr.right)}`;
    }
    visitGroupExpr(expr) {
      return `(${this.compile(expr.expr)})`;
    }
    visitLiteralExpr(expr) {
      return expr.value.toString();
    }
    visitUnaryExpr(expr) {
      return `${expr.operator}${this.compile(expr.right)}`;
    }
  };

  // ../compiler/out/Crest.js
  var Crest = class {
    static run(source) {
  ...
  // app.jsx
  var Canvas = (props) => {
    let canvasRef = (0, import_react.useRef)(null);
